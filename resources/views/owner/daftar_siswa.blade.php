            ...
            <div class="w-full">
                <div id="content" class="p-8">
                    ...
                    <div class="border-b-2 border-baseBlue w-full flex gap-6 mb-10">
                        ...
                        <button type="button" id="penggunaBtn"
                            class="rounded-t-lg py-2 px-4 bg-white text-baseBlue">Calon Siswa</button>
                    </div>
                    <!-- Pesan Error -->
                    @if ($errors->any())
            ...
            w-full h-screen"
                ...
                @if ($siswam)
                    @foreach ($siswam as $siswa)
                            ...
                            <div class="flex flex-col justify-center max-w-[350px]">
                                <div class="bg-white rounded-xl px-10 py-8">
                                    ...
                                    <div class="flex flex-col gap-4">
                                        ...
                                        <p class="font-semibold text-greyIcon text-balance text-center">
                                            Apakah anda yakin ingin menolak calon siswa bernama
                                            {{ $siswa->pengguna->biodataSiswa->nama_lengkap ?? '-' }}?
                                        </p>
                        ...
                        <!-- Akhir dari pop up tolak data siswa -->
                    @endforeach
                @endif
