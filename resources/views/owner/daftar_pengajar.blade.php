...
<body class="font-Inter text-regularContent">
                        ...
                        <div class="flex flex-col gap-4">
                            ...
                            <form action="" method="post">
                                <div class="flex justify-between gap-4 mt-4">
                                    <button type="button" onclick="showPopupHapusPengajar()" class="text-greyIcon hover:text-black w-full">Batal</button>
    ...
    <script>
        const showPopupHapusPengajar = () => {
            const popup = document.getElementById('popupHapusPengajar');
