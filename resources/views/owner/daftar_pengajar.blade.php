        ...
        <div class="flex max-w-[1440px]">
            ...
            <div class="w-full">
                ...
                <div class="top-0 left-0 hidden flex flex-col justify-center items-center fixed z-10 backdrop-blur-sm backdrop-brightness-50 drop-shadow-regularShadow 
                        w-full h-screen" id="popupDetailPengajar{{ $pengajar->pengguna->biodataPengajar->id_biodata }}">
                    <div class="flex flex-col justify-center md:min-w-[800px]">
                        <div class="bg-white rounded-xl px-10 py-8">
                            <div class="flex justify-between text-end">
                                ...
                                <button onclick="showPopupDetailPengajar({{ $pengajar->pengguna->biodataPengajar->id_biodata }})">
                            ...
                            <div class="flex flex-col gap-4">
                                <div class="py-4">
                                    ...
                                    <div class="grid grid-cols-2">
                                        <div class="flex flex-col gap-2">
                                            <p class="font-semibold">Nama: <span class="font-normal">{{  $pengajar->pengguna->biodataPengajar->nama_lengkap }}</span></p>
                                            <p class="font-semibold">Tanggal Lahir: <span class="font-normal">{{  $pengajar->pengguna->biodataPengajar->tmpt_tgl_lahir }}</span></p>
                                            <p class="font-semibold">Tempat: <span class="font-normal">{{  $pengajar->pengguna->biodataPengajar->alamat }}</span></p>
                                        </div>
                                        <div class="flex flex-col gap-2">
                                ...
                                <div class="flex justify-center mt-2">
                                    <button type="button" onclick="showPopupDetailPengajar({{ $pengajar->pengguna->biodataPengajar->id_biodata }})" class="text-baseBlue 
                ...
                <div class="top-0 left-0 hidden flex flex-col justify-center items-center fixed z-10 backdrop-blur-sm backdrop-brightness-50 drop-shadow-regularShadow 
                        w-full h-screen" id="popupUploadSertif{{ $pengajar->pengguna->biodataPengajar->id_biodata }}">
                    <div class="flex flex-col justify-center md:min-w-[500px]">
                            <div class="flex justify-between bg-baseBlue px-10 py-4 rounded-t-xl text-white">
                                ...
                                <button onclick="showPopupUploadSertif({{ $pengajar->pengguna->biodataPengajar->id_biodata }})">
                        ...
                        <div class="bg-white rounded-b-xl px-10 py-8">
                            ...
                            @csrf
                                ...
                                <input type="file" name="sertifikatPengajar" id="sertifikatPengajar" class="file:text-baseBlue file:font-semibold 
                                file:bg-baseBlue/20 file:rounded-full file:py-2 file:px-4 file:border-none file:cursor-pointer">
                                <div>
                                    <label for="keterangan">Keterangan</label>
                                    <textarea name="keterangan" id="keterangan" class="ps-3 border-t-0 border-r-0 border-l-0 border-b-2 border-greyBorder bg-greyBackground w-full p-1 mt-1" rows="2"></textarea>
                                </div>

                                <div class="flex justify-center gap-6 mb-2 mt-4">
                                    <button type="button" onclick="showPopupUploadSertif({{ $pengajar->pengguna->biodataPengajar->id_biodata }})" class="text-greyIcon hover:font-semibold">Batal</button>
                ...
                <div class="top-0 left-0 hidden flex flex-col justify-center items-center fixed z-10 backdrop-blur-sm backdrop-brightness-50 drop-shadow-regularShadow 
                        w-full h-screen" id="popupHapusPengajar{{ $pengajar->pengguna->biodataPengajar->id_biodata }}">
                    <div class="flex flex-col justify-center max-w-[350px]">
                        <div class="bg-white rounded-xl px-10 py-8">
                            <div class="text-end">
                                <button onclick="showPopupHapusPengajar({{ $pengajar->pengguna->biodataPengajar->id_biodata }})">
                                    <i class="fa-solid fa-xmark fa-lg text-greyIcon"></i>
                                </button>
                            </div>
                            ...
                            <div class="flex flex-col gap-4">
                                ...
                                Apakah anda yakin ingin menghapus {{ $pengajar->pengguna->biodataPengajar->nama_lengkap }}?
                                </p>
                        
                                <form action="" method="post">
                                    <div class="flex justify-between gap-4 mt-4">
                                        <button type="button" onclick="showPopupHapusPengajar({{ $pengajar->pengguna->biodataPengajar->id_biodata }})" class="text-greyIcon hover:text-black w-full">Batal</button>
