        ...
        <div class="flex max-w-[1440px]">
            ...
            <div class="w-full">
                <div id="content" class="p-8">
                    ...
                    <div
                        class="bg-baseDarkerGreen dark:bg-baseDarkerGreen/80 rounded-xl p-6 md:p-12 relative my-7 font-semibold text-white">
                                        ...
                                        <div id="contentPertemuan-0" class="hidden">
                                            ...
                                            <div class="bg-baseCream w-full rounded-b-xl">
                                                <div class="grid divide-y-2">
                                                    @if ($pertemuan->materi->isNotEmpty())
                                                        <div
                                                            class="flex gap-4 px-8 p-1.5 text-greyIcon text-smallContent">
                                                            <p>
                                            ...
                                            <div class="bg-baseCream w-full rounded-b-xl">
                                                @if ($pertemuan->tugas->isNotEmpty())
                                                    <div class="grid divide-y-2">
                                                        <div
                                                            class="flex gap-8 px-8 p-1.5 text-greyIcon text-smallContent">
