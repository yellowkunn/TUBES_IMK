            ...
            <div class="w-full">
                <div id="content" class="p-8">
                    ...
                    <div class="flex items-center gap-2 text-smallContent">
                        ...
                        <i class="fa-solid fa-caret-right text-baseBlue"></i>
                        <a href="" class="hover:font-semibold">Pertemuan $pertremuan->pertemuan_ke </a>
                    </div>

                    <div class="border-b-2 border-baseBlue w-full flex gap-6 mt-7">
                        <button type="button" id="BahanAjarBtn" class="rounded-t-lg bg-white py-2 px-4 text-white focus:font-semibold">Bahan Ajar</button>
                        <button type="button" id="absensiBtn" class="rounded-t-lg py-2 px-4 bg-white text-baseBlue focus:font-semibold">Absensi</button>
                    </div>
                    ...
                    <div id="BahanAjarContent" class="mt-6">
                        <div class="flex justify-between items-center mt-6">
                            ...
                            <select name="selectedBahan" id="filterBahan" class="w-44 bg-white border border-greyBorder text-greyIcon px-4 py-2 rounded-lg leading-tight focus:outline-none focus:bg-white focus:border-greyIcon">
                            ...
                            <div class="bg-white p-7 pt-4 rounded-b-xl">
                                <div class="flex flex-col gap-4">
                                    <div class="ms-4">
                                        ...
                                        <input type="time" model="waktuakses" id="waktuakses" class="border-2 border-baseBlue/20 bg-baseBlue/5 rounded-lg me-2">
                                        <input type="date" model="tanggalakses" id="tanggalakses" class="border-2 border-baseBlue/20 bg-baseBlue/5 rounded-lg">
                                    </div>
                                    <div class="w-full overflow-y-auto max-h-96">
                                        <div class="md:flex items-start">
                                            <div class="w-full px-3 py-1.5">
                                                <div class="flex justify-between gap-28 items-center border-2 border-baseBlue/20 bg-baseBlue/5 p-3 px-6 rounded-lg">
                                                    <p>Materi</p>
                                                    <button type="button" click="addmateri( $i )"><i class="fa-solid fa-plus p-2 px-[9px] bg-baseBlue text-white rounded-full"></i></button>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="flex flex-col">
                                            ...
                                            <div class="flex justify-between py-3 px-5">
                                                ...
                                                <input model="filemateri. $value " type="file" id="file. $value " class="file:text-baseBlue file:font-semibold 
                                                    file:bg-baseBlue/20 file:rounded-full file:py-2 file:px-4 file:border-none file:cursor-pointer">
                                                <button type="button" click="removemateri( $key )"><i class="fa-solid fa-xmark me-7"></i></button>
                                            </div>
                        ...
                        <div class="flex flex-col justify-center">
                            ...
                            <div class="bg-white p-7 pt-4 rounded-b-xl">
                                <div class="flex flex-col gap-4">
                                    <div class="ms-4">
                                        <p class="font-semibold mb-1.5">Waktu Akses</p>
                                        <input type="time" model="waktuakses2" id="waktuakses2" class="border-2 border-baseBlue/20 bg-baseBlue/5 rounded-lg me-2">
                                        <input type="date" model="tanggalakses2" id="tanggalakses2" class="border-2 border-baseBlue/20 bg-baseBlue/5 rounded-lg">
                                        <p class="font-semibold mb-1.5 mt-3">Tenggat Tugas</p>
                                        <input type="time" model="batas_waktu_akses_2" id="batas_waktu_akses_2" class="border-2 border-baseBlue/20 bg-baseBlue/5 rounded-lg me-2">
                                        <input type="date" model="batas_tanggal_akses_2" id="batas_tanggal_akses_2" class="border-2 border-baseBlue/20 bg-baseBlue/5 rounded-lg">
                                    </div>
                                </div>
                                <div class="mt-5">
                                    <div class="w-full overflow-y-auto max-h-96">
                                        <div class="md:flex items-start">
                                            <div class="w-full px-3 py-1.5">
                                                <div class="flex justify-between gap-28 items-center border-2 border-baseBlue/20 bg-baseBlue/5 p-3 px-6 rounded-lg">
                                                    <p>Latihan</p>
                                                    <button type="button" click="addlatihan( $i )" onclick="event.preventDefault();">
                                        ...
                                        <div class="flex flex-col">
                                            ...
                                            <div class="flex justify-between py-3 px-5">
                                                ...
                                                <input model="filelatihan. $value " type="file" id="file. $value " class="file:text-baseBlue file:font-semibold 
                                                file:bg-baseBlue/20 file:rounded-full file:py-2 file:px-4 file:border-none file:cursor-pointer">
                                                <button type="button" click="removelatihan( $key )"><i class="fa-solid fa-xmark me-7"></i></button>
                                            </div>
