        ...
        <div class="flex gap-24 justify-between w-full mt-4">
            <div class="flex flex-col gap-8 w-full">
                <div class="relative flex flex-col gap-3 w-full">
                    <p>Nama Lengkap</p>
                    <input type="text" id="text" name="text" required class="ps-3 border-t-0 border-r-0 border-l-0 border-b-2 border-greyBorder bg-greyBackground w-full p-1">  
                </div>
                <div class="relative flex flex-col gap-3 w-full">
                    <p>Tempat lahir</p>
                    <input type="text" id="text" name="text" required class="ps-3 border-t-0 border-r-0 border-l-0 border-b-2 border-greyBorder bg-greyBackground w-full p-1">  
                ...
                <div class="relative flex flex-col gap-3 w-full">
                    <p>Agama</p>
                    <input type="text" id="text" name="text" required class="px-3 border-t-0 border-r-0 border-l-0 border-b-2 border-greyBorder bg-greyBackground w-full p-1">  
                </div>
            ...
            <div class="flex gap-24 justify-between w-full">
                <div class="flex flex-col gap-8 w-full">   
                    ...
                    <div class="relative flex flex-col gap-3 w-full">
                        <p>Tanggal lahir</p>
                        <input type="date" id="text" name="text" required class="px-3 border-t-0 border-r-0 border-l-0 border-b-2 border-greyBorder bg-greyBackground w-full p-1">  
                    </div>
                    <div class="relative flex flex-col gap-3 w-full">
                        <p>Alamat</p>
                        <input type="text" id="text" name="text" required class="ps-3 border-t-0 border-r-0 border-l-0 border-b-2 border-greyBorder bg-greyBackground w-full p-1">  
