...
<body class="font-Inter dark:dark-mode">
    ...
    <div id="content" class="px-12 md:px-24 py-10 dark:border-t-2 dark:border-white">
        ...
        <div class="stepper relative my-12 md:my-20 flex gap-12 lg:gap-28 justify-center">
            <div id="step-circle-1"
                class="rounded-full bg-white text-black/70 dark:text-white dark:bg-[#374151]/40 border-2 border-[#7AA1E2] p-2 px-5 text-subtitle text-center">
                1</div>
        ...
        <div x-data="formHandler()">
            <form action="{{ url('/formulirpendaftaran') }}" id="formId" method="POST" enctype="multipart/form-data"
                ...
                <div class="flex flex-col mt-10 rounded-lg" id="tab-1">
                            ...
                            <div class="relative flex flex-col w-full">
                                ...
                                <select id="kelas" name="kelas"
                                    ...
                                    @foreach ($kelass as $kelas)
                                        <option value="{{ $kelas->id_kelas }}" class="dark:dark-mode">
                                            {{ $kelas->nama }}</option>
                                    @endforeach
                                </select>
                            </div>
                    ...
                    <p class="my-1">Fortunate Education Center menawarkan tiga pilihan jam kelas yang sudah pasti
                        tersedia.</p>
                        ...
                        <div class="mt-4 sm:mt-0">
                            <div class="relative flex flex-col gap-3 w-full">
                                ...
                                <select id="jam" name="jam"
                                    ...
                                    <option class="text-greyIcon dark:dark-mode" value="13.30-15.00">13.30-15.00
                                    </option>
                                    <option class="text-greyIcon dark:dark-mode" value="15.00-16.30">15.00-16.30
                                    </option>
                                    <option class="text-greyIcon dark:dark-mode" value="16.30-18.00">16.30-18.00
                                    </option>
                                </select>
                            </div>
                        </div>
                    ...
                    <p class="mt-1">Tidak sesuai dengan jadwal yang tersedia? Anda dapat memilih jadwal Anda sendiri.
                    </p>
                    <p class="mt-1">Namun, harap diperhatikan bahwa pemilihan jam kustom berisiko mendapat
                        <b>pembatalan pendaftaran</b> sebab <b>tidak tersedianya pengajar</b> untuk jadwal yang dipilih.
                    </p>
                        ...
                        <div class="mt-4 sm:mt-0">
                            <div class="relative flex flex-col gap-3 w-full">
                                ...
                                <select id="jamTambahan" name="jam"
                                    class="dark:focus:bg-[#374151]/40 pt-8 block appearance-none w-full bg-greyBackground dark:bg-[#374151]/40 dark:text-white dark:rounded dark:text-black border border-greyBorder text-greyIcon py-2 px-4 pr-8 rounded leading-tight focus:outline-none focus:bg-white focus:border-greyIcon">
                                    <option value="" class="text-greyIcon dark:dark-mode" disabled>Jam</option>
                                    <option class="text-greyIcon dark:dark-mode" value="09.00-10.30">09.00-10.30
                                    </option>
                                    <option class="text-greyIcon dark:dark-mode" value="10.30-12.00">10.30-12.00
                                    </option>
                                </select>
                            </div>
                        </div>
                ...
                <div class="flex flex-col mt-8 rounded-lg" id="tab-2">
                    ...
                    <div class="w-[150px] mb-10 mx-auto">
                        <input type="file" name="gambar" id="gambar" class="invisible" accept="image/*"
                            onchange="showFile(this)" required>
                        <button id="file" onclick="document.getElementById('gambar').click(); return false;"
                            class="p-2 py-3 w-full border rounded-xl shadow">
                            <div class="w-[130px] h-[170px] p-1 mb-2 flex justify-center">
                                <img src="" alt="" id="uploadedFile"
                                    class="max-w-full max-h-full rounded">
                            </div>
                            <div class="flex items-center justify-center gap-2">
                                <i
                                    class="fa-solid fa-arrow-up-from-bracket fa-sm text-greyIcon dark:text-white rounded-full w-fit"></i>
                    ...
                    <div class="w-full sm:grid grid-cols-2 md:grid-cols-3 gap-8 mt-4">
                        <div class="mt-4 sm:mt-0">
                            <div class="relative flex flex-col gap-3 w-full">
                                <label for="namalengkap"
                                    class="absolute top-2 left-4 text-smallContent text-[#717171] dark:text-white font-semibold">Nama
                                    Lengkap</label>
                        ...
                        <div class="mt-4 sm:mt-0">
                            <div class="relative flex flex-col gap-3 w-full">
                                <label for="tempatlahir"
                                    class="absolute top-2 left-4 text-smallContent text-[#717171] dark:text-white font-semibold">Tempat
                                    lahir</label>
                        ...
                        <div class="mt-4 sm:mt-0">
                            <div class="relative flex flex-col gap-3 w-full">
                                <label for="tanggallahir"
                                    class="absolute top-2 left-4 text-smallContent text-[#717171] dark:text-white font-semibold">Tanggal
                                    lahir</label>
                        ...
                        <div class="mt-4 sm:mt-0">
                            <div class="relative flex flex-col w-full">
                                <label for="gender"
                                    class="absolute top-2 left-4 text-smallContent text-[#717171] dark:text-white font-semibold">Jenis
                                    Kelamin</label>
                        ...
                        <div class="mt-4 sm:mt-0">
                            <div class="relative flex flex-col gap-3 w-full">
                                <label for="alamat"
                                    class="absolute top-2 left-4 text-smallContent text-[#717171] dark:text-white font-semibold">Alamat</label>
                        ...
                        <div class="mt-4 sm:mt-0">
                            <div class="relative flex flex-col gap-3 w-full">
                                <label for="agama"
                                    class="absolute top-2 left-4 text-smallContent text-[#717171] dark:text-white font-semibold">Agama</label>
                        ...
                        <div class="mt-4 sm:mt-0">
                            <div class="relative flex flex-col gap-3 w-full">
                                <label for="kewarganegaraan"
                                    class="absolute top-2 left-4 text-smallContent text-[#717171] dark:text-white font-semibold">Kewarganegaraan</label>
                    ...
                    <div>
                        ...
                        <div class="w-full sm:grid grid-cols-2 md:grid-cols-3 gap-8 mt-4">
                            <div class="mt-4 sm:mt-0">
                                <div class="relative flex flex-col gap-3 w-full">
                                    <label for="nohp"
                                        class="absolute top-2 left-4 text-smallContent text-[#717171] dark:text-white font-semibold">No.
                                        HP</label>
                            ...
                            <div class="mt-4 sm:mt-0">
                                <div class="relative flex flex-col gap-3 w-full">
                                    <label for="pendidikanterakhir"
                                        class="absolute top-2 left-4 text-smallContent text-[#717171] dark:text-white font-semibold">Pendidikan
                                        Terakhir</label>
                                    <input type="text" id="pendidikanterakhir" name="pendidikanterakhir" required
                                        class="ps-4 border-t-0 border-r-0 border-l-0 border-b-2 border-greyBorder bg-greyBackground dark:bg-[#374151]/40 dark:text-white rounded dark:text-black w-full pt-8">
                                </div>
                            </div>
                            <div class="mt-4 sm:mt-0">
                                <div class="relative flex flex-col gap-3 w-full">
                                    <label for="diterimakursus"
                                        class="absolute top-2 left-4 text-smallContent text-[#717171] dark:text-white font-semibold">Diterima
                                        di kursus ini</label>
                                    <input type="text" id="diterimakursus" name="diterimakursus" required
                                        class="ps-4 border-t-0 border-r-0 border-l-0 border-b-2 border-greyBorder bg-greyBackground dark:bg-[#374151]/40 dark:text-white rounded dark:text-black w-full pt-8">
                                </div>
                            </div>
                        </div>
                ...
                <div class="flex flex-col mt-8 rounded-lg" id="tab-3">
                    ...
                    <div class="w-full sm:grid grid-cols-2 md:grid-cols-3 gap-8 mt-4">
                        <div class="mt-4 sm:mt-0">
                            <div class="relative flex flex-col gap-3 w-full">
                                <label for="namaortu"
                                    class="absolute top-2 left-4 text-smallContent text-[#717171] dark:text-white font-semibold">Nama
                                    Orang Tua</label>
                                <input type="text" id="namaortu" name="namaortu" required
                                    class="ps-4 border-t-0 border-r-0 border-l-0 border-b-2 border-greyBorder bg-greyBackground dark:bg-[#374151]/40 dark:text-white rounded dark:text-black w-full pt-8">
                            </div>
                        </div>
                        ...
                        <div class="mt-4 sm:mt-0">
                            <div class="relative flex flex-col gap-3 w-full">
                                <label for="tempatlahirortu"
                                    class="absolute top-2 left-4 text-smallContent text-[#717171] dark:text-white font-semibold">Tempat
                                    Lahir</label>
                                <input type="text" id="tempatlahirortu" name="tempatlahirortu" required
                                    class="ps-4 border-t-0 border-r-0 border-l-0 border-b-2 border-greyBorder bg-greyBackground dark:bg-[#374151]/40 dark:text-white rounded dark:text-black w-full pt-8">
                            </div>
                        </div>
                        ...
                        <div class="mt-4 sm:mt-0">
                            <div class="relative flex flex-col gap-3 w-full">
                                <label for="pendidikanortu"
                                    class="absolute top-2 left-4 text-smallContent text-[#717171] dark:text-white font-semibold">Pendidikan</label>
                                <input type="text" id="pendidikanortu" name="pendidikanortu" required
                                    class="ps-4 border-t-0 border-r-0 border-l-0 border-b-2 border-greyBorder bg-greyBackground dark:bg-[#374151]/40 dark:text-white rounded dark:text-black w-full pt-8">
                            </div>
                        </div>
                        ...
                        <div class="mt-4 sm:mt-0">
                            <div class="relative flex flex-col gap-3 w-full">
                                <label for="agamaortu"
                                    class="absolute top-2 left-4 text-smallContent text-[#717171] dark:text-white font-semibold">Agama</label>
                                <input type="text" id="agamaortu" name="agamaortu" required
                                    class="ps-4 border-t-0 border-r-0 border-l-0 border-b-2 border-greyBorder bg-greyBackground dark:bg-[#374151]/40 dark:text-white rounded dark:text-black w-full pt-8">
                            </div>
                        </div>
                        ...
                        <div class="mt-4 sm:mt-0">
                            <div class="relative flex flex-col gap-3 w-full">
                                <label for="pekerjaanortu"
                                    class="absolute top-2 left-4 text-smallContent text-[#717171] dark:text-white font-semibold">Pekerjaan</label>
                                <input type="text" id="pekerjaanortu" name="pekerjaanortu" required
                                    class="ps-4 border-t-0 border-r-0 border-l-0 border-b-2 border-greyBorder bg-greyBackground dark:bg-[#374151]/40 dark:text-white rounded dark:text-black w-full pt-8">
                            </div>
                        </div>
                    </div>
                ...
                <div class="flex justify-end gap-4 sm:gap-16 w-full mt-16">
                    <button id="btnPrevious" type="button"
                        class="stepper-btn text-baseBlue hover:font-semibold dark:text-white">Sebelumnya</button>
                    <button id="btnReset" onclick="localStorage.clear();" type="reset"
                        class="stepper-btn w-[50px] hover:font-semibold">Reset</button>
                    <button id="btnNext" type="button"
                        class="stepper-btn w-[150px] p-3 bg-baseBlue/90 text-white rounded hover:bg-baseBlue">Selanjutnya</button>

                    <button id="btnSubmit" type="submit"
                        class="stepper-btn w-[220px] p-3 bg-baseBlue/90 text-white rounded hover:bg-baseBlue">Kirim</button>
                </div>
            </form>
        </div>
    ...
    <script>
        ...
        const inputElementIds = ['kelas', 'tingkat_kelas', 'jam', 'jamTambahan', 'namalengkap', 'tempatlahir', 'agama',
            'kewarganegaraan', 'gender',
