<div>
        ...
        @foreach ($kelass as $kelas)
            <div class="bg-white rounded-lg p-6 px-10 lg:px-12 drop-shadow-regularShadow relative group my-8 sm:my-0">
                ...
                <div>
                    ...
                    <div id="dd-menu{{ $loop->index }}"
                        ...
                        <button onclick="showPopupEditKelas({{ $kelas->id_kelas }})"
                            class="w-full h-full flex items-center gap-2 py-2 px-4">
                ...
                <div class="flex flex-col gap-2">
                    ...
                    @if ($kelas->foto)
                        <img src="{{ asset('berkas_ujis/' . $kelas->foto) }}" alt="{{ $kelas->nama }}"
                            class="my-2 max-h-52 md:max-h-56 lg:max-h-44 w-full object-cover rounded-lg">
                    @else
                    ...
                    <a href="{{ url('/editdetailkelas/' . $kelas->id_kelas) }}"
                        class="rounded-full bg-baseBlue/90 group-hover:bg-baseBlue text-white py-2 my-3 inline-block text-center">Lihat
                        Detail</a>
                </div>
                <div
                    class="absolute bg-baseBlue/90 group-hover:bg-baseBlue h-1 rounded-full bottom-0 left-1/2 transform -translate-x-1/2 w-1/4 group-hover:w-2/3 duration-500">
                </div>
            </div>
        @endforeach
    </div>
    ...
    <!-- pagination -->
    <div class="mt-16">{{ $kelass->links() }}</div>
                    ...
                    <div class="overflow-y-auto max-h-96 pe-7 flex flex-col gap-5 mt-5 px-0.5">
                        <div class="flex justify-between gap-14">
                            ...
                            <div class="w-full flex flex-col gap-6">
                                ...
                                <div>
                                    ...
                                    <input
                                        class="ps-3 border-t-0 border-r-0 border-l-0 border-b-2 border-greyBorder bg-greyBackground w-full p-1"
                                        type="text" name="fasilitas" id="fasilitas">
                                </div>
                                ...
                                <div>
                                    ...
                                    <input type="text"
                                        class="ps-3 border-t-0 border-r-0 border-l-0 border-b-2 border-greyBorder bg-greyBackground w-full p-1"
                                        type="text" name="durasi" id="durasi">
                                </div>
                            </div>
                            ...
                            <div class="w-full flex flex-col gap-6">
                                ...
                                <div>
                                    ...
                                    <div class="flex justify-between gap-2 h-9">
                                        ...
                                        <input
                                            class="ps-3 border-t-0 border-r-0 border-l-0 border-b-2 border-greyBorder bg-greyBackground w-full p-1"
                                            type="text" name="rentang" id="rentang" placeholder="Rentang">
                                    </div>
                                </div>
                                    ...
                                    <div class="flex gap-8">
                                        <div class="flex flex-col gap-4">
                                            <div class="flex items-center gap-2"><input type="checkbox"
                                                    class="rounded appearance-none checked:bg-baseBlue" id="senin"
                                                    name="hari[]" value="senin"><label for="senin">Senin</label>
                                            </div>
                                            <div class="flex items-center gap-2"><input type="checkbox"
                                                    class="rounded appearance-none checked:bg-baseBlue" id="kamis"
                                                    name="hari[]" value="kamis"><label for="kamis">Kamis</label>
                                            </div>
                                        </div>
                                        <div class="flex flex-col gap-4">
                                            <div class="flex items-center gap-2"><input type="checkbox"
                                                    class="rounded appearance-none checked:bg-baseBlue" id="selasa"
                                                    name="hari[]" value="selasa"><label
                                                    for="selasa">Selasa</label></div>
                                            <div class="flex items-center gap-2"><input type="checkbox"
                                                    class="rounded appearance-none checked:bg-baseBlue" id="jumat"
                                                    name="hari[]" value="jumat"><label for="jumat">Jumat</label>
                                            </div>
                                        </div>
                                        <div class="flex flex-col gap-4">
                                            <div class="flex items-center gap-2"><input type="checkbox"
                                                    class="rounded appearance-none checked:bg-baseBlue" id="rabu"
                                                    name="hari[]" value="rabu"><label for="rabu">Rabu</label>
                                            </div>
                                            <div class="flex items-center gap-2"><input type="checkbox"
                                                    class="rounded appearance-none checked:bg-baseBlue" id="sabtu"
                                                    name="hari[]" value="sabtu"><label for="sabtu">Sabtu</label>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="self-start">
                            ...
                            <div class="max-w-[320px] mb-10 mx-auto">
                                <button id="file"
                                    onclick="document.getElementById('gambar').click(); return false;"
                                    class="p-2 py-3 w-full border rounded-lg">
                                    ...
                                    <div class="flex items-center justify-center gap-2">
                                        <i
                                            class="fa-solid fa-arrow-up-from-bracket fa-sm text-greyIcon rounded-full w-fit"></i>
                                        <p class="text-greyIcon text-smallContent">Upload foto kelas</p>
                                    </div>
                                </button>
                                <p class="text-xs mt-3">*Maks 2MB</p>
                                <input type="file" name="gambar" id="gambar" class="invisible"
                                    accept="image/*" onchange="showFile(this)" required>
                            </div>
                        </div>
                    </div>

                    <div class="mt-8 flex justify-center gap-6">
                        <button type="button" onclick="showPopupTambahKelas()"
    ...
    @foreach ($kelass as $kelas)
        ...
        <div class="top-0 left-0 hidden flex flex-col justify-center items-center fixed z-10 backdrop-blur-sm backdrop-brightness-50 drop-shadow-regularShadow 
                    w-full h-screen"
            id="popupEditKelas{{ $kelas->id_kelas }}">
                ...
                <div class="bg-white p-7 pt-4 rounded-b-xl px-10 py-8">
                    <form method="post" class="flex flex-col gap-5">
                        ...
                        <div>
                            ...
                            <input
                                class="ps-3 border-t-0 border-r-0 border-l-0 border-b-2 border-greyBorder bg-greyBackground w-full p-1"
                                type="text" name="namaKelas" id="namaKelas" value="{{ $kelas->nama }}">
                        </div>
                        ...
                        <div>
                            ...
                            <input
                                class="ps-3 border-t-0 border-r-0 border-l-0 border-b-2 border-greyBorder bg-greyBackground w-full p-1"
                                type="text" name="keterangan" id="keterangan" value="{{ $kelas->deskripsi }}">
                        </div>
                        ...
                        <div>
                            ...
                            <div class="flex justify-between gap-4 h-9">
                                <input
                                    class="ps-3 border-t-0 border-r-0 border-l-0 border-b-2 border-greyBorder bg-greyBackground w-full p-1"
                                    type="number" name="harga" id="harga" value="{{ $kelas->harga }}">
                                <p class="text-2xl text-greyIcon my-auto">/</p>
                                <input
                                    class="ps-3 border-t-0 border-r-0 border-l-0 border-b-2 border-greyBorder bg-greyBackground w-full p-1"
                                    type="text" name="rentang" id="rentang" placeholder="Rentang"
                        ...
                        <div class="mt-8 flex justify-end gap-6">
                            <button type="button" onclick="showPopupEditKelas({{ $kelas->id_kelas }})"
        ...
        <div class="top-0 left-0 hidden flex flex-col justify-center items-center fixed z-10 backdrop-blur-sm backdrop-brightness-50 drop-shadow-regularShadow 
                    w-full h-screen"
            id="popupHapusKelas{{ $kelas->id_kelas }}">
                        ...
                        <svg fill="none" xmlns="http://www.w3.org/2000/svg" class="w-[52px] h-[52px] mx-auto">
                            ...
                            <defs>
                                <clipPath id="clip0_213_507">
                                    <rect width="2" height="16" fill="white" transform="translate(25 18)">
                                    </rect>
                                </clipPath>
                            </defs>
                        </svg>
