<form wire:submit="kehadiranSiswas" action="">
    ...
    <div class="mt-8 flex justify-end gap-6">
        ...
        <button type="submit" class="text-baseDarkerGreen bg-white border-2 border-baseDarkerGreen p-1.5 px-5 rounded-lg hover:bg-baseDarkerGreen hover:text-white hover:font-semibold" style="box-shadow: 0px 4px 5px 0 rgba(105,212,220,0.3);">Simpan</button>
    </div>
</form>
