<form wire:submit="tambahPertemuan" action="" enctype="multipart/form-data">
    ...
    <div class="md:flex justify-between gap-16">
            ...
            <div class="bg-white drop-shadow-regularShadow rounded-lg p-8 h-fit">
                <div class="flex flex-col gap-12">
                    <div class="flex flex-col gap-2">
                        ...
                        <input type="text" wire:model="pertemuan" id="pertemuan"
                    ...
                    <div class="flex flex-col gap-2">
                        ...
                        <input type="text" wire:model="topikbahasan" id="topikbahasan"
                            class="ps-3 border-t-0 border-r-0 border-l-0 border-b-2 border-greyBorder bg-greyBackground w-full p-1"
                            required>
                    </div>
        ...
        <div class="flex flex-col gap-5 w-1/2">
            ...
            <div class="bg-white drop-shadow-regularShadow rounded-lg p-5 h-fit">
                <div
                    class="flex justify-between items-center border-2 border-baseBlue/20 bg-baseBlue/5 rounded-lg p-3 px-6">
            ...
            <div class="bg-white drop-shadow-regularShadow rounded-lg p-5 h-fit">
                <div
                    class="flex justify-between items-center border-2 border-baseBlue/20 bg-baseBlue/5 rounded-lg p-3 px-6">
                    <button type="button" class="w-full h-full" onclick="showPopupLink()">
                        <input type="hidden" wire:model="link" id="link">
                        <div class="flex items-center gap-3">
                            <i class="fa-regular fa-file"></i>
                            <p class="text-start hover:font-semibold">Tambah Link</p>
                        </div>
            ...
            <div class="bg-white p-7 pt-4 rounded-b-xl">
                <div class="flex flex-col gap-4">
                    <div class="ms-4">
                        ...
                        <input type="time" wire:model="waktuakses" id="waktuakses"
                            class="border-2 border-baseBlue/20 bg-baseBlue/5 rounded-lg me-2">
                        <input type="date" wire:model="tanggalakses" id="tanggalakses"
                        ...
                        <div class="md:flex items-start">
                            <div class="w-full px-3 py-1.5">
                                <div
                                    ...
                                    <p>Materi</p>
                                    <button type="button" wire:click="addmateri({{ $i }})"><i
                                            class="fa-solid fa-plus p-2 px-[9px] bg-baseBlue text-white rounded-full"></i></button>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="flex flex-col">
                            @foreach ($boxinputmateri as $key => $value)
                                <div class="flex justify-between py-3 px-5">
                                    ...
                                    <input wire:model="filemateri.{{ $value }}" type="file"
                                        id="file.{{ $value }}"
                                    ...
                                    <button type="button" wire:click="removemateri({{ $key }})"><i
        ...
        <div class="flex flex-col justify-center">
            ...
            <div class="bg-white p-7 pt-4 rounded-b-xl">
                <div class="flex flex-col gap-4">
                    <div class="ms-4">
                        <p class="font-semibold mb-1.5">Waktu Akses</p>
                        <input type="time" wire:model="waktuakses2" id="waktuakses2"
                            class="border-2 border-baseBlue/20 bg-baseBlue/5 rounded-lg me-2">
                        <input type="date" wire:model="tanggalakses2" id="tanggalakses2"
                            class="border-2 border-baseBlue/20 bg-baseBlue/5 rounded-lg">
                        <p class="font-semibold mb-1.5 mt-3">Tenggat Tugas</p>
                        <input type="time" wire:model="batas_waktu_akses_2" id="batas_waktu_akses_2"
                            class="border-2 border-baseBlue/20 bg-baseBlue/5 rounded-lg me-2">
                        <input type="date" wire:model="batas_tanggal_akses_2" id="batas_tanggal_akses_2"
                            class="border-2 border-baseBlue/20 bg-baseBlue/5 rounded-lg">
                    </div>
                </div>
                <div class="mt-5">
                        ...
                        <div class="md:flex items-start">
                            <div class="w-full px-3 py-1.5">
                                <div
                                    class="flex justify-between gap-28 items-center border-2 border-baseBlue/20 bg-baseBlue/5 p-3 px-6 rounded-lg">
                                    <p>Latihan</p>
                                    <button type="button" wire:click="addlatihan({{ $i }})"
                                ...
                                <div class="rounded-lg">
                                    <div id="divInputFileMateri"
                                        class="grid grid-cols-3 bg-neutral-100 border-4 border-white"></div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="flex flex-col">
                            @foreach ($boxinputlatihan as $key => $value)
                                <div class="flex justify-between py-3 px-5">
                                    ...
                                    <input wire:model="filelatihan.{{ $value }}" type="file"
                                        id="file.{{ $value }}"
                                        class="file:text-baseBlue file:font-semibold 
                                file:bg-baseBlue/20 file:rounded-full file:py-2 file:px-4 file:border-none file:cursor-pointer">
                                    <button type="button" wire:click="removelatihan({{ $key }})"><i
                                            class="fa-solid fa-xmark me-7"></i></button>
                                </div>
                            @endforeach
                        </div>
                        ...
                        <div class="md:flex items-start">
                            <div class="w-full px-3 py-1.5">
                                <div
                                    class="flex justify-between gap-28 items-center border-2 border-baseBlue/20 bg-baseBlue/5 p-3 px-6 rounded-lg">
                                    <p>Link</p>
                                    <button type="button" wire:click="addlink({{ $i }})"><i
                                            class="fa-solid fa-plus p-2 px-[9px] bg-baseBlue text-white rounded-full"></i>
                                    </button>
                                </div>
                            </div>
                            ...
                            <div class="flex flex-col">
                                @foreach ($boxinputlink as $key => $value)
                                    <div class="flex justify-between py-3 px-5">
                                        ...
                                        <input wire:model="links.{{ $value }}" type="url"
                                            id="link.{{ $value }}"
    ...
    <div class="flex gap-10 justify-center items-center mt-12 mb-4">
        ...
        <button type="submit"
            class="text-baseBlue bg-white border-2 border-baseBlue p-1.5 px-8 rounded-lg 
                                hover:bg-baseBlue hover:text-white hover:font-semibold"
            style="filter: drop-shadow(0px 0px 5px rgba(121,162,226,0.3));">Simpan</button>
    </div>
</form>
