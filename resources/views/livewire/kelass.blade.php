...
<div class="sm:grid grid-cols-2 gap-4 lg:gap-12 mt-8">
    ...
    <div class="p-6 lg:p-8 px-8 md:px-6 lg:px-10 bg-white dark:bg-[#374151]/40 drop-shadow-regularShadow rounded-lg flex flex-col gap-2 my-8 sm:my-4 md:my-0 group">
        ...
        <button wire:click="baru_diakses({{ $kelas->kelas_id }})"
            ...
            class="text-center dark:bg-[#313A49] text-white group-hover:font-semibold bg-baseBlue/80 group-hover:bg-baseBlue w-full rounded-lg py-2 mt-4">
        Lihat Detail
    </button>
