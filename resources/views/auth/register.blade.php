...
<body class="font-Inter text-regularContent">
    ...
    <div class="flex flex-col gap-4">
        <input type="email" id="email" name="email" autofocus autocomplete="on" required="{{ old('email') }}" class="border-2 border-greyBorder w-full p-2.5 rounded" placeholder="Email">
        <x-input-error :messages="$errors->get('email')" class="mt-2" />

        <input type="text" id="username" name="username" autocomplete="on" required="{{ old('username') }}" class="border-2 border-greyBorder w-full p-2.5 rounded" placeholder="Username">
