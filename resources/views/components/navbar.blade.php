<div class="mt-2 bg-white hidden md:block text-smallContent dark:dark-mode">
    <div class="flex justify-between items-center px-8 lg:px-12 py-5">
        ...
        <div class="pe-4 my-auto">
            ...
            <div id="dd-menu" class="invisible grid grid-cols-1 divide-y bg-white mt-2 rounded-md drop-shadow-regularShadow absolute md:top-14 lg:top-16 md:right-10 lg:right-14">
                ...
                <form method="POST" action="{{ route('logout') }}">
                    @csrf
                    <button type="submit" class="w-full h-full flex items-center gap-2 py-2 px-4 text-black">
...
<div class="relative block md:hidden bg-white">
    <div class="flex justify-between items-center px-2 sm:px-6 md:px-8 py-5">
        <a href="{{ route('berandasiswa') }}"><p class="text-baseBlue text-center font-bold leading-snug ms-1.5">Fortunate<br>Education Center</p></a>
