<div class="bg-white pt-3 h-screen my-5 w-screen md:w-1/6 duration-500" id="sidebarContent">
    <div class="px-8 ms-1 flex flex-col gap-12 lg:gap-14 text-regularContent font-semibold text-greyIcon">
        ...
        <a href="{{ route('pengaturanruangan') }}">
            <div class="flex h-14 items-center gap-3 absolute left-0 w-5/6 lg:w-full py-3 {{ request()->routeIs('pengaturanruangan') ? 'bg-baseDarkerGreen text-white font-normal rounded-r-lg' : '' }}">
