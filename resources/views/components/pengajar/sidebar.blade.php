<div class="bg-white pt-3 max-h-[1024px] z-10">
    <p class="text-baseDarkerGreen text-center font-bold text-[20px] pb-16 px-6">Fortunate Education Center</p>
    
    <div class="px-12 flex flex-col gap-6 lg:gap-10 text-regularContent font-semibold text-greyIcon">
        ...
        <div class="my-24">
            <hr>
            <div class="flex items-center gap-4 mt-7 ps-1">
