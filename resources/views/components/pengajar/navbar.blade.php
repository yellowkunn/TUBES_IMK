...
<div class="flex justify-between px-4 h-20">
    <div class="flex gap-6 items-center">
        ...
        <a href="{{ route('pengajar.kelas') }}" class="text-regularContent font-semibold nav" style="color: #363636">Kelas Saya</a>
    </div>
    ...
    <button id="dd-more" class="flex items-center">
        ...
        <div id="dd-menu" class="invisible grid grid-cols-1 divide-y bg-white mt-2 rounded-md drop-shadow-regularShadow absolute top-12 right-5 text-black transform">
            <a href="" class="w-full h-full flex items-center gap-2 py-2 px-4">
