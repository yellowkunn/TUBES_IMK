    ...
    */
    ...
    'connections' => [
        ...
        'pengajar' => [
            'driver' => 'mysql',
            'url' => env('DATABASE_URL'),
            'host' => env('DB_HOST_PENGAJAR', '127.0.0.1'),
            'port' => env('DB_PORT_PENGAJAR', '3306'),
            'database' => env('DB_DATABASE_PENGAJAR', 'forge'),
            'username' => env('DB_USERNAME_PENGAJAR', 'forge'),
            'password' => env('DB_PASSWORD_PENGAJAR', ''),
            'unix_socket' => env('DB_SOCKET', ''),
            'charset' => 'utf8mb4',
            'collation' => 'utf8mb4_unicode_ci',
            'prefix' => '',
        ...
        'siswa' => [
            'driver' => 'mysql',
            'url' => env('DATABASE_URL'),
            'host' => env('DB_HOST_SISWA', '127.0.0.1'),
            'port' => env('DB_PORT_SISWA', '3306'),
            'database' => env('DB_DATABASE_SISWA', 'forge'),
            'username' => env('DB_USERNAME_SISWA', 'forge'),
